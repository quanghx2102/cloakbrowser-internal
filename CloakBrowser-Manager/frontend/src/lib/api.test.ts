...
describe("api.createProfile", () => {
  it("sends POST with JSON body", async () => {
    ...
    expect(url).toBe("http://127.0.0.1:8080/api/profiles");
...
describe("api.updateProfile", () => {
  it("sends PUT with JSON body", async () => {
    ...
    const [url, options] = mockFetch.mock.calls[0];
    expect(url).toBe("http://127.0.0.1:8080/api/profiles/1");
...
describe("api.launchProfile", () => {
  it("sends POST to launch endpoint", async () => {
    ...
    expect(mockFetch.mock.calls[0][0]).toBe("http://127.0.0.1:8080/api/profiles/1/launch");
  });
});
...
describe("api.stopProfile", () => {
  it("sends POST to stop endpoint", async () => {
    ...
    expect(mockFetch.mock.calls[0][0]).toBe("http://127.0.0.1:8080/api/profiles/1/stop");
  });
});
...
describe("api.setClipboard", () => {
  it("sends POST with text body", async () => {
    ...
    const [url, options] = mockFetch.mock.calls[0];
    expect(url).toBe("http://127.0.0.1:8080/api/profiles/1/clipboard");
    expect(options.method).toBe("POST");
